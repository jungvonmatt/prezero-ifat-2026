<template>
  <div class="game-grid">
    ...
    <Transition name="tooltip">
      <div v-if="hasResult && result?.label" class="tooltip-info">
    ...
    <!-- Recent Circles Overlay - show if result -->
    <Transition name="recent-circles">
      <div v-if="hasResult" class="recent-circles">
        <p class="recent-circles-title">History</p>
