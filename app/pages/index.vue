    ...
    <Transition name="sidebar">
      <aside v-if="Boolean(result)" class="sidebar">
        <div class="scores-header">
          <svg fill="#f0f0f0" height="48" viewBox="0 -960 960 960" width="48" xmlns="http://www.w3.org/2000/svg">
            <path
              d="m145.39-185.39h193.15v-349.22h-193.15zm238.53 0h192.16v-589.22h-192.16zm237.54 0h193.15v-269.22h-193.15zm-521.46 45.39v-440h238.54v-240h282.92v320h238.54v360z" />
          </svg>
          <h2>Scores</h2>
        </div>
        <CmHighscore
